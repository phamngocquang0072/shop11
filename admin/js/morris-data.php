    <?php
        include '../../config.php';
        $queryDT = mysqli_query($conn, "SELECT * 
            FROM tbl_sanpham, tbl_chitiethoadon, tbl_donhang, tbl_loaisanpham, tbl_sanpham
            WHERE tbl_sanpham.maSanPham = tbl_chitiethoadon.maSP and
            tbl_donhang.maDonHang = tbl_sanpham.maDonHang and
