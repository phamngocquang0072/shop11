<?php
	$pageTitle = "KIỂM TRA ĐỊA CHỈ | B.STORE - Hệ thống quần áo chính hãng";
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
						...
						<?php $db=mysqli_query($conn,"SELECT * FROM `devvn_tinhthanhpho`"); ?>
						...
						<label>Chọn tỉnh/thành phố:</label>
							<div class="birth-day delivery-address">
								...
								<?php  while($row=mysqli_fetch_array($db)) { print_r($row);?>
